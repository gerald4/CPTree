...
# =============================================================================
	...
	filepath = f'../../dataset_benchmark/{dataset}/OSDT_crossval_result_{dataset}.csv'
	for lamb in lambs:
        #for i in range(1, 11): # 10 folds

		file_test = file_train.replace("train","test")
...
if __name__ == "__main__":
	...
	parser.add_argument("--lamb",help="lambda", type=float, default=0)
