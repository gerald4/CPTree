...
# -*- coding: utf-8 -*-
"""
Created on Sun Feb  2 14:24:27 2020
...
if __name__=='__main__':
    ...
    path_train = f'../dataset_benchmark/{dataset}/{dataset}_{evaluation_method}_train_{step}.csv'
    path_test = f'../dataset_benchmark/{dataset}/{dataset}_{evaluation_method}_val_{step}.csv'
    ...
    C=class_names
    filepath = f'crossval_result/CPTree_{dataset}_{evaluation_method}_step={step}_depth={depth}.csv'


    print("*******Model Construction********")
    print("******Iteration ", str(step), str(l))
