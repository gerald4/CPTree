...
def main(argv):
   ...
   outputfile = ''
   try:
      opts, args = getopt.getopt(argv,"f:d:s:t:p:r:e:o:p:l:b:m:c:x:",["ifile=","depth=","start=","timelimit=","polishtime=","relax=","error=","objective=","penalty=","layer=","boolean=","max_depth=","count_max=","forest_bounds="])
