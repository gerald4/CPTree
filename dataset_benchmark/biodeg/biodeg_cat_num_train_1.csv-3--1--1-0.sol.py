...
def predict(row,header):
  if float(row[header["Feat0"]]) <= 4.797499999999999:
    if float(row[header["Feat35"]]) <= 3.675:
      if float(row[header["Feat9"]]) <= 0.5:
        return 0.0
      if float(row[header["Feat9"]]) > 0.5:
        return 1.0
    if float(row[header["Feat35"]]) > 3.675:
      if float(row[header["Feat11"]]) <= -0.7949999999999999:
        return 1.0
      if float(row[header["Feat11"]]) > -0.7949999999999999:
        return 0.0
  if float(row[header["Feat0"]]) > 4.797499999999999:
    if float(row[header["Feat39"]]) <= 0.5:
      if float(row[header["Feat19"]]) <= 1.5:
        return 0.0
      if float(row[header["Feat19"]]) > 1.5:
        return 0.0
    if float(row[header["Feat39"]]) > 0.5:
      if float(row[header["Feat4"]]) <= 3.5:
        return 1.0
      if float(row[header["Feat4"]]) > 3.5:
        return 0.0
