...
train = "biodeg_cat_num_train_4.csv"
test = "biodeg_cat_num_test_4.csv"
    ...
    if float(row[header["Feat37"]]) <= 1.5:
      if float(row[header["Feat37"]]) <= 0.5:
        ...
        if float(row[header["Feat2"]]) > 0.5:
          return 0.0
      if float(row[header["Feat37"]]) > 0.5:
        if float(row[header["Feat26"]]) <= 1.979:
          return 1.0
        if float(row[header["Feat26"]]) > 1.979:
          return 0.0
    if float(row[header["Feat37"]]) > 1.5:
      if float(row[header["Feat0"]]) <= 5.8420000000000005:
        if float(row[header["Feat22"]]) <= 5.5:
          return 0.0
        if float(row[header["Feat22"]]) > 5.5:
          return 0.0
      if float(row[header["Feat0"]]) > 5.8420000000000005:
  ...
  if float(row[header["Feat0"]]) > 4.785500000000001:
    if float(row[header["Feat6"]]) <= 4.5:
      if float(row[header["Feat18"]]) <= 1.0:
        if float(row[header["Feat39"]]) <= 0.5:
          return 0.0
        if float(row[header["Feat39"]]) > 0.5:
          return 1.0
      if float(row[header["Feat18"]]) > 1.0:
        if float(row[header["Feat0"]]) <= 4.7524999999999995:
          return 0.0
        if float(row[header["Feat0"]]) > 4.7524999999999995:
          return 0.0
    if float(row[header["Feat6"]]) > 4.5:
      if float(row[header["Feat21"]]) <= 1.2035:
        if float(row[header["Feat39"]]) <= 0.5:
          return 0.0
        if float(row[header["Feat39"]]) > 0.5:
          return 1.0
