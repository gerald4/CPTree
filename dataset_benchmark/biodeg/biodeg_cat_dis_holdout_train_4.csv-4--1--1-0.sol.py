...
train = "biodeg_cat_dis_holdout_train_4.csv"
test = "biodeg_cat_dis_holdout_test_4.csv"
def predict(row,header):
  if float(row[header["Feat38_0.0"]]) <= 0.5:
    if float(row[header["Feat0_2.0"]]) <= 0.5:
      if float(row[header["Feat9_2.0"]]) <= 0.5:
        if float(row[header["Feat13_0.0"]]) <= 0.5:
          return 0.0
        if float(row[header["Feat13_0.0"]]) > 0.5:
          return 0.0
      if float(row[header["Feat9_2.0"]]) > 0.5:
    ...
    if float(row[header["Feat0_2.0"]]) > 0.5:
      if float(row[header["Feat1_1.0"]]) <= 0.5:
        ...
        if float(row[header["Feat0_1.0"]]) > 0.5:
          return 1.0
      if float(row[header["Feat1_1.0"]]) > 0.5:
        if float(row[header["Feat21_0.0"]]) <= 0.5:
          return 0.0
        if float(row[header["Feat21_0.0"]]) > 0.5:
          return 1.0
  if float(row[header["Feat38_0.0"]]) > 0.5:
    if float(row[header["Feat9_2.0"]]) <= 0.5:
      if float(row[header["Feat37_1.0"]]) <= 0.5:
        if float(row[header["Feat14_0.0"]]) <= 0.5:
          return 0.0
        if float(row[header["Feat14_0.0"]]) > 0.5:
          return 1.0
      if float(row[header["Feat37_1.0"]]) > 0.5:
    ...
    if float(row[header["Feat9_2.0"]]) > 0.5:
      if float(row[header["Feat0_1.0"]]) <= 0.5:
        ...
        if float(row[header["Feat0_0.0"]]) > 0.5:
          return 1.0
      if float(row[header["Feat0_1.0"]]) > 0.5:
        if float(row[header["Feat21_2.0"]]) <= 0.5:
          return 1.0
        if float(row[header["Feat21_2.0"]]) > 0.5:
          return 0.0
