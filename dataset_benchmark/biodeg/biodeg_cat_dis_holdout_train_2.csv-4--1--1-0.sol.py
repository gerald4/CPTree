...
train = "biodeg_cat_dis_holdout_train_2.csv"
test = "biodeg_cat_dis_holdout_test_2.csv"
  ...
  if float(row[header["Feat35_0.0"]]) <= 0.5:
    if float(row[header["Feat15_1.0"]]) <= 0.5:
      if float(row[header["Feat14_0.0"]]) <= 0.5:
        if float(row[header["Feat34_1.0"]]) <= 0.5:
          return 0.0
        if float(row[header["Feat34_1.0"]]) > 0.5:
          return 0.0
      if float(row[header["Feat14_0.0"]]) > 0.5:
        ...
        if float(row[header["Feat9_2.0"]]) > 0.5:
          return 1.0
    if float(row[header["Feat15_1.0"]]) > 0.5:
      if float(row[header["Feat38_2.0"]]) <= 0.5:
    ...
    if float(row[header["Feat37_1.0"]]) <= 0.5:
      if float(row[header["Feat0_1.0"]]) <= 0.5:
        ...
        if float(row[header["Feat0_0.0"]]) > 0.5:
          return 1.0
      if float(row[header["Feat0_1.0"]]) > 0.5:
        if float(row[header["Feat36_0.0"]]) <= 0.5:
          return 1.0
        if float(row[header["Feat36_0.0"]]) > 0.5:
          return 1.0
    if float(row[header["Feat37_1.0"]]) > 0.5:
