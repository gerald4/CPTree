...
def predict(row,header):
  if float(row[header["Feat33"]]) <= 2.5:
    if float(row[header["Feat0"]]) <= 4.797499999999999:
      if float(row[header["Feat35"]]) <= 3.6935000000000002:
        return 1.0
      if float(row[header["Feat35"]]) > 3.6935000000000002:
        return 0.0
    if float(row[header["Feat0"]]) > 4.797499999999999:
      ...
      if float(row[header["Feat18"]]) > 1.0:
        return 0.0
  if float(row[header["Feat33"]]) > 2.5:
    if float(row[header["Feat15"]]) <= 5.5:
      if float(row[header["Feat39"]]) <= 1.5:
        return 0.0
      if float(row[header["Feat39"]]) > 1.5:
        return 1.0
    if float(row[header["Feat15"]]) > 5.5:
      if float(row[header["Feat38"]]) <= 8.616:
        return 1.0
      if float(row[header["Feat38"]]) > 8.616:
        return 0.0
