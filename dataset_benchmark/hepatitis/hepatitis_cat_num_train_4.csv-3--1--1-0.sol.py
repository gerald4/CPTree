...
def predict(row,header):
  if float(row[header["anorexia_2.0"]]) <= 0.5:
    if float(row[header["protime"]]) <= 75.5:
      if float(row[header["bilirubin"]]) <= 2.5999999999999996:
        return 1.0
      if float(row[header["bilirubin"]]) > 2.5999999999999996:
        return 0.0
    if float(row[header["protime"]]) > 75.5:
      if float(row[header["protime"]]) <= 95.0:
        return 0.0
      if float(row[header["protime"]]) > 95.0:
        return 1.0
  if float(row[header["anorexia_2.0"]]) > 0.5:
    if float(row[header["malaise_2.0"]]) <= 0.5:
      ...
      if float(row[header["protime"]]) > 44.5:
        return 1.0
    if float(row[header["malaise_2.0"]]) > 0.5:
      if float(row[header["albumin"]]) <= 2.6500000000000004:
        return 0.0
      if float(row[header["albumin"]]) > 2.6500000000000004:
        return 1.0
