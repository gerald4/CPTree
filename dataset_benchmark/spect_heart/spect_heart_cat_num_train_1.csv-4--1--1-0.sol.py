...
train = "spect_heart_cat_num_train_1.csv"
test = "spect_heart_cat_num_test_1.csv"
def predict(row,header):
  if float(row[header["F1_1"]]) <= 0.5:
    if float(row[header["F11_1"]]) <= 0.5:
      if float(row[header["F8_1"]]) <= 0.5:
        if float(row[header["F16_1"]]) <= 0.5:
          return 0.0
        if float(row[header["F16_1"]]) > 0.5:
          return 1.0
      if float(row[header["F8_1"]]) > 0.5:
        if float(row[header["F13_1"]]) <= 0.5:
          return 0.0
        if float(row[header["F13_1"]]) > 0.5:
          return 1.0
    if float(row[header["F11_1"]]) > 0.5:
      if float(row[header["F6_1"]]) <= 0.5:
        if float(row[header["F9_1"]]) <= 0.5:
          return 1.0
        if float(row[header["F9_1"]]) > 0.5:
          return 1.0
      if float(row[header["F6_1"]]) > 0.5:
        if float(row[header["F19_1"]]) <= 0.5:
          return 0.0
        if float(row[header["F19_1"]]) > 0.5:
          return 1.0
  if float(row[header["F1_1"]]) > 0.5:
    ...
    if float(row[header["F13_1"]]) > 0.5:
      if float(row[header["F5_1"]]) <= 0.5:
        if float(row[header["F4_1"]]) <= 0.5:
          return 0.0
        if float(row[header["F4_1"]]) > 0.5:
          return 1.0
      if float(row[header["F5_1"]]) > 0.5:
        if float(row[header["F2_1"]]) <= 0.5:
          return 1.0
        if float(row[header["F2_1"]]) > 0.5:
          return 1.0
