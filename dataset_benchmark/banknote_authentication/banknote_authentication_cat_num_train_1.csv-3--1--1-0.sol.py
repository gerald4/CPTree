...
def predict(row,header):
  if float(row[header["Variance_of_wavelet"]]) <= 0.31155499999999997:
    if float(row[header["Variance_of_wavelet"]]) <= -4.2873:
      if float(row[header["Variance_of_wavelet"]]) <= -1.18315:
        return 1.0
      if float(row[header["Variance_of_wavelet"]]) > -1.18315:
        return 0.0
    if float(row[header["Variance_of_wavelet"]]) > -4.2873:
      if float(row[header["skewness_of_wavelet"]]) <= 5.1918500000000005:
        return 1.0
      if float(row[header["skewness_of_wavelet"]]) > 5.1918500000000005:
        return 0.0
  if float(row[header["Variance_of_wavelet"]]) > 0.31155499999999997:
    if float(row[header["curtosis_of_wavelet"]]) <= -1.59275:
      if float(row[header["skewness_of_wavelet"]]) <= 5.21045:
        return 1.0
      if float(row[header["skewness_of_wavelet"]]) > 5.21045:
        return 0.0
    if float(row[header["curtosis_of_wavelet"]]) > -1.59275:
      if float(row[header["Variance_of_wavelet"]]) <= 1.2109:
        return 0.0
      if float(row[header["Variance_of_wavelet"]]) > 1.2109:
        return 0.0
