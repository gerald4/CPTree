...
def predict(row,header):
  if float(row[header["Feat17"]]) <= 0.04732:
    if float(row[header["Feat26"]]) <= 0.9999450147151947:
      ...
      if float(row[header["Feat4"]]) > 0.14597500000000002:
        return 1.0
    if float(row[header["Feat26"]]) > 0.9999450147151947:
      if float(row[header["Feat17"]]) <= 0.19468000000000002:
        return 0.0
      if float(row[header["Feat17"]]) > 0.19468000000000002:
        return 1.0
  if float(row[header["Feat17"]]) > 0.04732:
    if float(row[header["Feat3"]]) <= -0.6096349999999999:
      if float(row[header["Feat0"]]) <= 0.5:
        return 0.0
      if float(row[header["Feat0"]]) > 0.5:
        return 0.0
    if float(row[header["Feat3"]]) > -0.6096349999999999:
      if float(row[header["Feat4"]]) <= 0.23154000000000002:
        return 0.0
      if float(row[header["Feat4"]]) > 0.23154000000000002:
        return 1.0
