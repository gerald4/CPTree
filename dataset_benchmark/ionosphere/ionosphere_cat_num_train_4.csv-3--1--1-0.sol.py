...
def predict(row,header):
  if float(row[header["Feat4"]]) <= 0.8182050000000001:
    if float(row[header["Feat15"]]) <= -0.40020500000000003:
      if float(row[header["Feat4"]]) <= 0.83071:
        return 0.0
      if float(row[header["Feat4"]]) > 0.83071:
        return 1.0
    if float(row[header["Feat15"]]) > -0.40020500000000003:
      if float(row[header["Feat4"]]) <= 0.2315400019288063:
        return 0.0
      if float(row[header["Feat4"]]) > 0.2315400019288063:
        return 1.0
  if float(row[header["Feat4"]]) > 0.8182050000000001:
    if float(row[header["Feat2"]]) <= 0.6396900000000001:
      if float(row[header["Feat21"]]) <= 0.172765:
        return 0.0
      if float(row[header["Feat21"]]) > 0.172765:
        return 1.0
    if float(row[header["Feat2"]]) > 0.6396900000000001:
      if float(row[header["Feat26"]]) <= 0.999945:
        return 1.0
      if float(row[header["Feat26"]]) > 0.999945:
        return 0.0
