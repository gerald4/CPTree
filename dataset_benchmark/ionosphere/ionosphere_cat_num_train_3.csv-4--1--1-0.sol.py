...
def predict(row,header):
  if float(row[header["Feat4"]]) <= 0.58223:
    if float(row[header["Feat31"]]) <= -0.26115:
      if float(row[header["Feat11"]]) <= 0.040215:
        if float(row[header["Feat33"]]) <= -0.15409499999999998:
          return 0.0
        if float(row[header["Feat33"]]) > -0.15409499999999998:
          return 0.0
      if float(row[header["Feat11"]]) > 0.040215:
        if float(row[header["Feat30"]]) <= 0.6983900000000001:
          return 0.0
        if float(row[header["Feat30"]]) > 0.6983900000000001:
          return 1.0
    if float(row[header["Feat31"]]) > -0.26115:
      if float(row[header["Feat7"]]) <= -0.000375:
        if float(row[header["Feat4"]]) <= 0.2318:
          return 0.0
        if float(row[header["Feat4"]]) > 0.2318:
          return 1.0
      if float(row[header["Feat7"]]) > -0.000375:
        ...
        if float(row[header["Feat4"]]) > 0.041440000000000005:
          return 1.0
  if float(row[header["Feat4"]]) > 0.58223:
    if float(row[header["Feat16"]]) <= 0.288165:
      if float(row[header["Feat3"]]) <= -0.146965:
        if float(row[header["Feat31"]]) <= 0.83309:
          return 0.0
        if float(row[header["Feat31"]]) > 0.83309:
          return 0.0
      if float(row[header["Feat3"]]) > -0.146965:
    ...
    if float(row[header["Feat16"]]) > 0.288165:
      if float(row[header["Feat0"]]) <= 0.5:
        ...
        if float(row[header["Feat0"]]) > 0.5:
          return 0.0
      if float(row[header["Feat0"]]) > 0.5:
        if float(row[header["Feat26"]]) <= 0.99921:
          return 1.0
        if float(row[header["Feat26"]]) > 0.99921:
          return 0.0
