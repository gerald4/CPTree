...
def predict(row,header):
  if float(row[header["Feat6"]]) <= 1.4300000000000002:
    if float(row[header["Feat9"]]) <= 3.825:
      if float(row[header["Feat11"]]) <= 3.1100000000000003:
        return 1.0
      if float(row[header["Feat11"]]) > 3.1100000000000003:
        return 0.0
    if float(row[header["Feat9"]]) > 3.825:
  ...
  if float(row[header["Feat6"]]) > 1.4300000000000002:
    if float(row[header["Feat12"]]) <= 719.0:
      if float(row[header["Feat12"]]) <= 697.5:
        return 1.0
      if float(row[header["Feat12"]]) > 697.5:
        return 1.0
    if float(row[header["Feat12"]]) > 719.0:
