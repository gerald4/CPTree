...
def predict(row,header):
  if float(row[header["Feat10"]]) <= 0.965:
    if float(row[header["Feat3"]]) <= 20.25:
      if float(row[header["Feat6"]]) <= 2.54:
        if float(row[header["Feat11"]]) <= 2.19:
          return 2.0
        if float(row[header["Feat11"]]) > 2.19:
          return 1.0
      if float(row[header["Feat6"]]) > 2.54:
        ...
        if float(row[header["Feat9"]]) > 3.8449999999999998:
          return 0.0
    if float(row[header["Feat3"]]) > 20.25:
      if float(row[header["Feat9"]]) <= 4.96:
        if float(row[header["Feat8"]]) <= 1.0350000000000001:
          return 2.0
        if float(row[header["Feat8"]]) > 1.0350000000000001:
          return 1.0
      if float(row[header["Feat9"]]) > 4.96:
        if float(row[header["Feat10"]]) <= 0.925:
          return 2.0
        if float(row[header["Feat10"]]) > 0.925:
          return 1.0
  if float(row[header["Feat10"]]) > 0.965:
    if float(row[header["Feat0"]]) <= 12.754999999999999:
      if float(row[header["Feat4"]]) <= 120.5:
        if float(row[header["Feat4"]]) <= 110.5:
          return 1.0
        if float(row[header["Feat4"]]) > 110.5:
          return 0.0
      if float(row[header["Feat4"]]) > 120.5:
        ...
        if float(row[header["Feat0"]]) > 12.754999999999999:
          return 0.0
    if float(row[header["Feat0"]]) > 12.754999999999999:
      if float(row[header["Feat12"]]) <= 730.0:
        if float(row[header["Feat12"]]) <= 842.5:
          return 1.0
        if float(row[header["Feat12"]]) > 842.5:
          return 2.0
      if float(row[header["Feat12"]]) > 730.0:
        if float(row[header["Feat9"]]) <= 3.4600000381469727:
          return 1.0
        if float(row[header["Feat9"]]) > 3.4600000381469727:
          return 0.0
