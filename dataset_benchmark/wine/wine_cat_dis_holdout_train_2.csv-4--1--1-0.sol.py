...
train = "wine_cat_dis_holdout_train_2.csv"
test = "wine_cat_dis_holdout_test_2.csv"
def predict(row,header):
  if float(row[header["Feat6_0.0"]]) <= 0.5:
    if float(row[header["Feat4_2.0"]]) <= 0.5:
      if float(row[header["Feat0_0.0"]]) <= 0.5:
        if float(row[header["Feat12_2.0"]]) <= 0.5:
          return 1.0
        if float(row[header["Feat12_2.0"]]) > 0.5:
          return 0.0
      if float(row[header["Feat0_0.0"]]) > 0.5:
        ...
        if float(row[header["Feat6_0.0"]]) > 0.5:
          return 0.0
    if float(row[header["Feat4_2.0"]]) > 0.5:
      if float(row[header["Feat9_0.0"]]) <= 0.5:
        if float(row[header["Feat0_0.0"]]) <= 0.5:
          return 0.0
        if float(row[header["Feat0_0.0"]]) > 0.5:
          return 1.0
    ...
    if float(row[header["Feat3_0.0"]]) <= 0.5:
      ...
      if float(row[header["Feat8_1.0"]]) > 0.5:
        ...
        if float(row[header["Feat9_0.0"]]) > 0.5:
          return 1.0
    if float(row[header["Feat3_0.0"]]) > 0.5:
      if float(row[header["Feat12_1.0"]]) <= 0.5:
        if float(row[header["Feat0_0.0"]]) <= 0.5:
          return 1.0
        if float(row[header["Feat0_0.0"]]) > 0.5:
          return 1.0
