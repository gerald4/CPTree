...
def predict(row,header):
  if float(row[header["Feat12"]]) <= 572.0:
    if float(row[header["Feat12"]]) <= 719.0:
      if float(row[header["Feat6"]]) <= 0.99:
        if float(row[header["Feat1"]]) <= 2.925:
          return 1.0
        if float(row[header["Feat1"]]) > 2.925:
          return 2.0
      if float(row[header["Feat6"]]) > 0.99:
        if float(row[header["Feat9"]]) <= 6.609999999999999:
          return 1.0
        if float(row[header["Feat9"]]) > 6.609999999999999:
          return 2.0
    if float(row[header["Feat12"]]) > 719.0:
      if float(row[header["Feat3"]]) <= 27.75:
        if float(row[header["Feat1"]]) <= 4.515:
          return 2.0
        if float(row[header["Feat1"]]) > 4.515:
          return 2.0
      if float(row[header["Feat3"]]) > 27.75:
        ...
        if float(row[header["Feat0"]]) > 14.175:
          return 2.0
  if float(row[header["Feat12"]]) > 572.0:
    if float(row[header["Feat9"]]) <= 3.82:
      if float(row[header["Feat0"]]) <= 13.04:
        ...
        if float(row[header["Feat3"]]) > 27.75:
          return 1.0
      if float(row[header["Feat0"]]) > 13.04:
        if float(row[header["Feat7"]]) <= 0.645:
          return 0.0
        if float(row[header["Feat7"]]) > 0.645:
          return 2.0
    if float(row[header["Feat9"]]) > 3.82:
      if float(row[header["Feat0"]]) <= 12.71:
