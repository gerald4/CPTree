...
def predict(row,header):
  if float(row[header["Feat3"]]) <= 585815.0:
    if float(row[header["Feat3"]]) <= 254630.0:
      if float(row[header["Feat8"]]) <= 8.5:
        return 0.0
      if float(row[header["Feat8"]]) > 8.5:
        return 0.0
    if float(row[header["Feat3"]]) > 254630.0:
      if float(row[header["Feat4"]]) <= 2478.5:
        return 0.0
      if float(row[header["Feat4"]]) > 2478.5:
        return 1.0
  if float(row[header["Feat3"]]) > 585815.0:
    if float(row[header["Feat9"]]) <= 2.5:
      if float(row[header["Feat3"]]) <= 627870.0:
        return 1.0
      if float(row[header["Feat3"]]) > 627870.0:
        return 0.0
    if float(row[header["Feat9"]]) > 2.5:
      if float(row[header["Feat3"]]) <= 1505475.0:
        return 1.0
      if float(row[header["Feat3"]]) > 1505475.0:
        return 0.0
