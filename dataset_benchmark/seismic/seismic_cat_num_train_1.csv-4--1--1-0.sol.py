...
train = "seismic_cat_num_train_1.csv"
test = "seismic_cat_num_test_1.csv"
def predict(row,header):
  if float(row[header["Feat12_1"]]) <= 0.5:
    if float(row[header["Feat4"]]) <= 2945.5:
      if float(row[header["Feat12_1"]]) <= 0.5:
        if float(row[header["Feat4"]]) <= 2888.0:
          return 0.0
        if float(row[header["Feat4"]]) > 2888.0:
          return 1.0
      if float(row[header["Feat12_1"]]) > 0.5:
        if float(row[header["Feat3"]]) <= 32770.0:
          return 1.0
        if float(row[header["Feat3"]]) > 32770.0:
          return 1.0
    if float(row[header["Feat4"]]) > 2945.5:
      if float(row[header["Feat6"]]) <= 94.5:
        if float(row[header["Feat11"]]) <= 1.5:
          return 0.0
        if float(row[header["Feat11"]]) > 1.5:
          return 1.0
      if float(row[header["Feat6"]]) > 94.5:
        if float(row[header["Feat7"]]) <= 1.5:
          return 1.0
        if float(row[header["Feat7"]]) > 1.5:
          return 0.0
  if float(row[header["Feat12_1"]]) > 0.5:
    if float(row[header["Feat6"]]) <= 5.5:
      if float(row[header["Feat3"]]) <= 25145.0:
        if float(row[header["Feat3"]]) <= 60365.0:
          return 0.0
        if float(row[header["Feat3"]]) > 60365.0:
          return 0.0
      if float(row[header["Feat3"]]) > 25145.0:
        ...
        if float(row[header["Feat1_1"]]) > 0.5:
          return 1.0
    if float(row[header["Feat6"]]) > 5.5:
      if float(row[header["Feat3"]]) <= 35480.0:
        if float(row[header["Feat12_1"]]) <= 0.5:
          return 1.0
        if float(row[header["Feat12_1"]]) > 0.5:
          return 0.0
