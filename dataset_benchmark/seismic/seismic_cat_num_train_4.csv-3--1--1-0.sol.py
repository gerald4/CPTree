...
def predict(row,header):
  if float(row[header["Feat17"]]) <= 7500.0:
    if float(row[header["Feat9"]]) <= 2.5:
      if float(row[header["Feat8"]]) <= 5.5:
        return 0.0
      if float(row[header["Feat8"]]) > 5.5:
        return 1.0
    if float(row[header["Feat9"]]) > 2.5:
      if float(row[header["Feat3"]]) <= 789740.0:
        return 0.0
      if float(row[header["Feat3"]]) > 789740.0:
        return 1.0
  if float(row[header["Feat17"]]) > 7500.0:
    if float(row[header["Feat5"]]) <= -59.5:
      if float(row[header["Feat16"]]) <= 40500.0:
        return 1.0
      if float(row[header["Feat16"]]) > 40500.0:
        return 0.0
    if float(row[header["Feat5"]]) > -59.5:
