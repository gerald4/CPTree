...
def predict(row,header):
  if float(row[header["Feat6"]]) <= 89.5:
    if float(row[header["Feat1_1"]]) <= 0.5:
      if float(row[header["Feat4"]]) <= 1253.5:
        if float(row[header["Feat6"]]) <= 90.5:
          return 0.0
        if float(row[header["Feat6"]]) > 90.5:
          return 1.0
      if float(row[header["Feat4"]]) > 1253.5:
        if float(row[header["Feat5"]]) <= -29.5:
          return 1.0
        if float(row[header["Feat5"]]) > -29.5:
          return 0.0
    if float(row[header["Feat1_1"]]) > 0.5:
      if float(row[header["Feat12_1"]]) <= 0.5:
        if float(row[header["Feat11"]]) <= 2.5:
          return 0.0
        if float(row[header["Feat11"]]) > 2.5:
          return 1.0
      if float(row[header["Feat12_1"]]) > 0.5:
        ...
        if float(row[header["Feat12_1"]]) > 0.5:
          return 0.0
  if float(row[header["Feat6"]]) > 89.5:
    if float(row[header["Feat3"]]) <= 60345.0:
      if float(row[header["Feat3"]]) <= 40100.0:
        if float(row[header["Feat0_1"]]) <= 0.5:
          return 0.0
        if float(row[header["Feat0_1"]]) > 0.5:
          return 0.0
      if float(row[header["Feat3"]]) > 40100.0:
        if float(row[header["Feat17"]]) <= 150000.0:
          return 0.0
        if float(row[header["Feat17"]]) > 150000.0:
          return 0.0
    if float(row[header["Feat3"]]) > 60345.0:
