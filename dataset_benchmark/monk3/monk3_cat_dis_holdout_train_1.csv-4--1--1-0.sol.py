...
train = "monk3_cat_dis_holdout_train_1.csv"
test = "monk3_cat_dis_holdout_test_1.csv"
def predict(row,header):
  if float(row[header["a2_3"]]) <= 0.5:
    if float(row[header["a5_2"]]) <= 0.5:
      if float(row[header["a5_4"]]) <= 0.5:
        if float(row[header["a2_3"]]) <= 0.5:
          return 1.0
        if float(row[header["a2_3"]]) > 0.5:
          return 1.0
