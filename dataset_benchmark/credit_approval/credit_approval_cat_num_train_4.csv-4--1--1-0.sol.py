...
train = "credit_approval_cat_num_train_4.csv"
test = "credit_approval_cat_num_test_4.csv"
def predict(row,header):
  if float(row[header["A5_gg"]]) <= 0.5:
    if float(row[header["A7_bb"]]) <= 0.5:
      if float(row[header["A9_t"]]) <= 0.5:
        if float(row[header["A11"]]) <= 21.5:
          return 1.0
        if float(row[header["A11"]]) > 21.5:
          return 0.0
      if float(row[header["A9_t"]]) > 0.5:
        if float(row[header["A14"]]) <= 521.5:
          return 0.0
        if float(row[header["A14"]]) > 521.5:
          return 1.0
    if float(row[header["A7_bb"]]) > 0.5:
      if float(row[header["A10_t"]]) <= 0.5:
        if float(row[header["A2"]]) <= 26.0:
          return 0.0
        if float(row[header["A2"]]) > 26.0:
          return 1.0
      if float(row[header["A10_t"]]) > 0.5:
        ...
        if float(row[header["A9_t"]]) > 0.5:
          return 0.0
  if float(row[header["A5_gg"]]) > 0.5:
    if float(row[header["A2"]]) <= 75.78999999999999:
      if float(row[header["A2"]]) <= 75.78999999999999:
        ...
        if float(row[header["A13_s"]]) > 0.5:
          return 0.0
      if float(row[header["A2"]]) > 75.78999999999999:
        if float(row[header["A8"]]) <= 9.73:
          return 1.0
        if float(row[header["A8"]]) > 9.73:
          return 0.0
    if float(row[header["A2"]]) > 75.78999999999999:
      if float(row[header["A1_b"]]) <= 0.5:
        if float(row[header["A3"]]) <= 25.1675:
          return 1.0
        if float(row[header["A3"]]) > 25.1675:
          return 0.0
      if float(row[header["A1_b"]]) > 0.5:
