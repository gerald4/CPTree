...
train = "credit_approval_cat_num_train_2.csv"
test = "credit_approval_cat_num_test_2.csv"
def predict(row,header):
  if float(row[header["A4_y"]]) <= 0.5:
    if float(row[header["A14"]]) <= 441.5:
      if float(row[header["A4_l"]]) <= 0.5:
        ...
        if float(row[header["A9_t"]]) > 0.5:
          return 0.0
      if float(row[header["A4_l"]]) > 0.5:
        if float(row[header["A8"]]) <= 2.2075:
          return 1.0
        if float(row[header["A8"]]) > 2.2075:
          return 0.0
    if float(row[header["A14"]]) > 441.5:
      if float(row[header["A10_t"]]) <= 0.5:
        if float(row[header["A15"]]) <= 262.5:
          return 1.0
        if float(row[header["A15"]]) > 262.5:
          return 0.0
      if float(row[header["A10_t"]]) > 0.5:
    ...
    if float(row[header["A10_t"]]) <= 0.5:
      if float(row[header["A9_t"]]) <= 0.5:
        ...
        if float(row[header["A5_p"]]) > 0.5:
          return 1.0
      if float(row[header["A9_t"]]) > 0.5:
        if float(row[header["A15"]]) <= 246.5:
          return 1.0
        if float(row[header["A15"]]) > 246.5:
          return 0.0
    if float(row[header["A10_t"]]) > 0.5:
      if float(row[header["A6_ff"]]) <= 0.5:
        if float(row[header["A9_t"]]) <= 0.5:
          return 1.0
        if float(row[header["A9_t"]]) > 0.5:
          return 0.0
      if float(row[header["A6_ff"]]) > 0.5:
        if float(row[header["A6_q"]]) <= 0.5:
          return 1.0
        if float(row[header["A6_q"]]) > 0.5:
          return 0.0
