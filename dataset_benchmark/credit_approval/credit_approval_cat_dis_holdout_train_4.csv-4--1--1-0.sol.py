...
train = "credit_approval_cat_dis_holdout_train_4.csv"
test = "credit_approval_cat_dis_holdout_test_4.csv"
def predict(row,header):
    ...
    if float(row[header["A3_0.0"]]) <= 0.5:
      if float(row[header["A7_bb"]]) <= 0.5:
        ...
        if float(row[header["A9_t"]]) > 0.5:
          return 0.0
      if float(row[header["A7_bb"]]) > 0.5:
        if float(row[header["A11_1.0"]]) <= 0.5:
          return 1.0
        if float(row[header["A11_1.0"]]) > 0.5:
          return 0.0
    if float(row[header["A3_0.0"]]) > 0.5:
  ...
  if float(row[header["A4_l"]]) > 0.5:
    if float(row[header["A15_1.0"]]) <= 0.5:
      if float(row[header["A3_2.0"]]) <= 0.5:
