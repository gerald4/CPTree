    ...
    if float(row[header["A7_j"]]) > 0.5:
      ...
      if float(row[header["A1_b"]]) > 0.5:
        ...
        if float(row[header["A7_v"]]) > 0.5:
          return 0.0
  if float(row[header["A7_ff"]]) > 0.5:
    if float(row[header["A2"]]) <= 47.375:
      if float(row[header["A6_cc"]]) <= 0.5:
        if float(row[header["A2"]]) <= 71.295:
          return 1.0
        if float(row[header["A2"]]) > 71.295:
          return 1.0
      if float(row[header["A6_cc"]]) > 0.5:
        ...
        if float(row[header["A2"]]) > 71.295:
          return 1.0
    if float(row[header["A2"]]) > 47.375:
      if float(row[header["A2"]]) <= 54.705:
        if float(row[header["A8"]]) <= 13.6875:
          return 1.0
        if float(row[header["A8"]]) > 13.6875:
          return 0.0
      if float(row[header["A2"]]) > 54.705:
