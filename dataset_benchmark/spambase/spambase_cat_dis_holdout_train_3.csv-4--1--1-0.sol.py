...
train = "spambase_cat_dis_holdout_train_3.csv"
test = "spambase_cat_dis_holdout_test_3.csv"
def predict(row,header):
    ...
    if float(row[header["Feat51_1.0"]]) <= 0.5:
      ...
      if float(row[header["Feat4_1.0"]]) > 0.5:
        ...
        if float(row[header["Feat20_0.0"]]) > 0.5:
          return 0.0
    if float(row[header["Feat51_1.0"]]) > 0.5:
      if float(row[header["Feat55_0.0"]]) <= 0.5:
        if float(row[header["Feat54_0.0"]]) <= 0.5:
          return 1.0
        if float(row[header["Feat54_0.0"]]) > 0.5:
          return 1.0
      if float(row[header["Feat55_0.0"]]) > 0.5:
  ...
  if float(row[header["Feat56_0.0"]]) > 0.5:
    if float(row[header["Feat20_0.0"]]) <= 0.5:
      if float(row[header["Feat55_1.0"]]) <= 0.5:
        if float(row[header["Feat56_1.0"]]) <= 0.5:
          return 0.0
        if float(row[header["Feat56_1.0"]]) > 0.5:
          return 0.0
      if float(row[header["Feat55_1.0"]]) > 0.5:
