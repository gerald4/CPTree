...
def predict(row,header):
  if float(row[header["Feat26"]]) <= 0.21000000000000002:
    if float(row[header["Feat24"]]) <= 0.445:
      if float(row[header["Feat51"]]) <= 0.0805:
        return 0.0
      if float(row[header["Feat51"]]) > 0.0805:
        return 1.0
    if float(row[header["Feat24"]]) > 0.445:
      ...
      if float(row[header["Feat28"]]) > 0.475:
        return 0.0
  if float(row[header["Feat26"]]) > 0.21000000000000002:
    if float(row[header["Feat11"]]) <= 1.2349999999999999:
      if float(row[header["Feat30"]]) <= 0.045:
        return 0.0
      if float(row[header["Feat30"]]) > 0.045:
        return 0.0
    if float(row[header["Feat11"]]) > 1.2349999999999999:
      if float(row[header["Feat0"]]) <= 1.55:
        return 0.0
      if float(row[header["Feat0"]]) > 1.55:
        return 0.0
