...
train = "iris_cat_num_train_4.csv"
test = "iris_cat_num_test_4.csv"
  ...
  if float(row[header["Petal_length"]]) <= 5.15:
    if float(row[header["Petal_length"]]) <= 4.95:
      if float(row[header["Petal_width"]]) <= 1.65:
        if float(row[header["Petal_width"]]) <= 0.8:
          return 0.0
        if float(row[header["Petal_width"]]) > 0.8:
          return 1.0
      if float(row[header["Petal_width"]]) > 1.65:
        ...
        if float(row[header["Sepal_width"]]) > 3.1500000000000004:
          return 1.0
    if float(row[header["Petal_length"]]) > 4.95:
      if float(row[header["Sepal_width"]]) <= 2.6500000000000004:
        if float(row[header["Sepal_length"]]) <= 5.95:
          return 2.0
        if float(row[header["Sepal_length"]]) > 5.95:
          return 2.0
      if float(row[header["Sepal_width"]]) > 2.6500000000000004:
        if float(row[header["Petal_width"]]) <= 1.6500000357627869:
          return 1.0
        if float(row[header["Petal_width"]]) > 1.6500000357627869:
          return 2.0
  if float(row[header["Petal_length"]]) > 5.15:
    if float(row[header["Sepal_length"]]) <= 5.45:
      if float(row[header["Sepal_length"]]) <= 7.05:
        ...
        if float(row[header["Sepal_length"]]) > 7.05:
          return 2.0
      if float(row[header["Sepal_length"]]) > 7.05:
        if float(row[header["Sepal_length"]]) <= 6.55:
          return 2.0
        if float(row[header["Sepal_length"]]) > 6.55:
          return 2.0
    if float(row[header["Sepal_length"]]) > 5.45:
