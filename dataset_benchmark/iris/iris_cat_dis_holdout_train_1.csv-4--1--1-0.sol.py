...
train = "iris_cat_dis_holdout_train_1.csv"
test = "iris_cat_dis_holdout_test_1.csv"
def predict(row,header):
  if float(row[header["Sepal_width_1.0"]]) <= 0.5:
    if float(row[header["Sepal_width_0.0"]]) <= 0.5:
